...
describe("highestWaveEachDay", () => {
    ...
    const waveArray2: Array<waveObject>  =[{"timestamp":1595656800,"swell":{"absMaxBreakingHeight":0}}, {"timestamp":1595743200,"swell":{"absMaxBreakingHeight":0}}];
    ...
    const waveArray3: Array<waveObject>  =[{"timestamp":1595656800,"swell":{"absMaxBreakingHeight":0.5}}, {"timestamp":1595649600,"swell":{"absMaxBreakingHeight":2}}];
    ...
    const waveArray4: Array<waveObject>  =[{"timestamp":1595649600,"swell":{"absMaxBreakingHeight":0.5}}, {"timestamp":1595649599,"swell":{"absMaxBreakingHeight":2}}];
...
describe("initialResponse", () => {
    const waveArray: Array<waveObject>  =[{"timestamp":1595649600,"swell":{"absMaxBreakingHeight":2}}];
    ...
    const waveArray2: Array<waveObject>  =[{"timestamp":1595649600,"swell":{"absMaxBreakingHeight":5}}];
    ...
    const waveArray3: Array<waveObject>  =[{"timestamp":1595649600,"swell":{"absMaxBreakingHeight":3}}];
...
describe("highestWaveResponse", () => {
    const waveArray: Array<waveObject>  =[{"timestamp":1595649600,"swell":{"absMaxBreakingHeight":2}}, {"timestamp":1594526400,"swell":{"absMaxBreakingHeight":5}}];
...
describe("highestWaveEachDayResponse", () => {
    const waveArray: Array<waveObject>  =[{"timestamp":1594526400,"swell":{"absMaxBreakingHeight":5}}, {"timestamp":1594612800,"swell":{"absMaxBreakingHeight":3}}];
    it("should say the highest waves will be 5ft", () => {
...
describe("wavesOverThreeFeetResponse", () => {
    ...
    const waveArray2: Array<waveObject>  =[{"timestamp":1595649600,"swell":{"absMaxBreakingHeight":2}}, {"timestamp":1594526400,"swell":{"absMaxBreakingHeight":3}}];
...
describe("todayWaveResponse", () => {
    ...
    const waveArray2: Array<waveObject>  =[{"timestamp":1594526400,"swell":{"absMaxBreakingHeight":3}}, {"timestamp":1595649600,"swell":{"absMaxBreakingHeight":2}}];
...
describe("chartHighestWaveEachDayUrl", () => {
    const waveArray: Array<waveObject> = [{ timestamp: 1595656800, swell: { absMaxBreakingHeight: 0.55 } },{ timestamp: 1595808000, swell: { absMaxBreakingHeight: 0.65 } },{ timestamp: 1595894400, swell: { absMaxBreakingHeight: 1.15 } },{ timestamp: 1595937600, swell: { absMaxBreakingHeight: 0.76 } },{ timestamp: 1596067200, swell: { absMaxBreakingHeight: 0.55 } }]
    it("should properly format data into chart url", () => {
